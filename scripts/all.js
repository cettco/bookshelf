...
(function(a, b) {
	...
	var c = a.document,
		...
		f = function() {
			...
			}), A = e.uaMatch(z), A.browser && (e.browser[A.browser] = !0, e.browser.version = A.version), e.browser.webkit && (e.browser.safari = !0), j.test("聽") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? C = function() {
	...
	a.widget("ui.slider", a.ui.mouse, {
		...
		_create: function() {
			var b = this,
				...
				f = "<a class='ui-slider-handle ui-state-default ui-corner-all'></a>",
 ...
 * Build: http://modernizr.com/download/#-csstransforms-csstransforms3d-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
